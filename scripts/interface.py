...
yearnVaults = [
        "0x2D5D4869381C4Fce34789BC1D38aCCe747E295AE", #crv-Rai Vault -- Minter
        #"0xF59D66c1d593Fb10e2f8c2a6fD2C958792434B9c", #Curve OUSD Pool -- NO MINTER int128
        #"0x1025b1641d1F23C289412Dd5E5701e9810103a93", #Curve ibAUD-USDC Pool -- Minter uint256
        #"0x6B5ce31AF687a671a804d8070Ddda99Cab926dfE", #Curve ibGBP-USDC Pool -- Minter uint256
        #"0x2e5c7e9B1Da0D9Cb2832eBb06241d18552A85400", #Curve ibCHF-USDC Pool -- Minter uint256
        #"0xE5eDcE53e39Cbc6d819E2C340BCF295e0084ff7c", #Curve ibEUR-USDC Pool --minter uint256 
        "0x1635b506a88fBF428465Ad65d00e8d6B6E5846C3", #Curve CVX-ETH Pool --minter uint256
        "0x4560b99C904aAD03027B5178CCa81584744AC01f", #Curve cvxCRV pool --no minter int128
        "0x6A5468752f8DB94134B6508dAbAC54D3b45efCE6", #Curve CRV-ETH pool --Minter uint256
        "0x341bb10D8f5947f3066502DC8125d9b8949FD3D6", #Curve STG-USDC pool --Minter uint256
        "0xdCD90C7f6324cfa40d7169ef80b12031770B4325", #Curve stETH pool yVault --Underlying token is null
        "0xE537B5cc158EB71037D4125BDD7538421981E6AA", #Curve 3Crypto Pool --Minter uint256
        "0x790a60024bC3aea28385b60480f15a0771f26D09", #Curve YFI-ETH Pool --Minter uint256
    ]
